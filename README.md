...
## how it works
This algorithm uses ord() and chr() to get ASCII (or Unicode idk) values for each character you give. It alters the values and turns them back into ASCII (or Unicode)
